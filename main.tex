...
\membrodabancadois{Juliana Martins de Oliveira}
...
\membrodabancatres{Belmondo Rodrigues Aragão Junior}
...
\begin{document}
	...
	\input{elementos-textuais/descricao-do-software}
	\input{elementos-textuais/descricao-do-software-detalhado}
