...
\begin{alineascomnumero}
\item FABRIK(cinemática inversa de alcance para frente e para trás): Carregamento e renderização do modelo 3D usando OpenGL e Assimp.
\item GGD(Descida de coordenação ciclica): Gerenciamento de entradas via SDL (teclado, joystick).
